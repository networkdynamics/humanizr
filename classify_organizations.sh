...
echo ./op-classifier/src/ml-classifier/scripts/classifier -m resources/model.model -o $OUTPUT $DIR/op-classifier/src/ml-classifier/src/ml2/libsvm_settings.txt /tmp/organization_personal_testing.json
